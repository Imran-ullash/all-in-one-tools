...
export { SITE_URL, getSiteUrl } from '@/lib/site';
...
export const TOOLS: Tool[] = [
     ...
     --------------------------------------------------------- */
  {
    ...
    metaTitle: 'Age Calculator - Calculate Exact Chronological Age Online',
  ...
  },
  {
    ...
    metaTitle: 'BMI Calculator - Free Body Mass Index & Healthy Weight Tool',
  ...
  },
  {
    ...
    metaTitle: 'Percentage Calculator - Calculate Percentages, Discounts & Ratios',
  ...
  },
  {
    ...
    metaTitle: 'Loan Calculator - Calculate Monthly EMI, Interest & Amortization',
     ...
     --------------------------------------------------------- */
  {
    ...
    metaTitle: 'Word Counter - Free Live Word, Character & Reading Time Tool',
  ...
  },
  {
    ...
    metaTitle: 'Character Counter - Detailed Letters, Digits & Space Counter',
  ...
  },
  {
    ...
    metaTitle: 'Remove Duplicate Lines - Deduplicate & Sort Text Lists',
     ...
     --------------------------------------------------------- */
  {
    ...
    metaTitle: 'Image Compressor - Compress JPG, PNG & WebP Images Free',
  ...
  },
  {
    ...
    metaTitle: 'Image Resizer - Resize Images by Pixels or Percentage Free',
  ...
  },
  {
    ...
    metaTitle: 'JPG to PNG Converter - Convert JPG to PNG Lossless Free',
  ...
  },
  {
    ...
    metaTitle: 'PNG to JPG Converter - Convert PNG to JPG with Background Color',
     ...
     --------------------------------------------------------- */
  {
    ...
    metaTitle: 'JSON Formatter - Beautify, Minify & Pretty Print JSON',
  ...
  },
  {
    ...
    metaTitle: 'JSON Validator - Validate JSON & Inspect Syntax Errors Online',
  ...
  },
  {
    ...
    metaTitle: 'Base64 Encoder - Convert Text & UTF-8 to Base64 Online',
  ...
  },
  {
    ...
    metaTitle: 'Base64 Decoder - Decode Base64 Strings to Text Online',
  ...
  },
  {
    ...
    metaTitle: 'UUID Generator - Generate Random UUID v4 & GUIDs in Bulk',
