...
export default function TextToolsPage() {
  ...
  const categoryTools = TOOLS.filter((t) => t.categorySlug === 'text-tools');
      ...
      <div className="container section-py-sm">
        <nav className="breadcrumb-nav" aria-label="Breadcrumb">
          <ol className="breadcrumb-list">
            ...
            <li className="breadcrumb-item active" aria-current="page">Text Tools</li>
          </ol>
        </nav>
        ...
        <AdBanner slot="text-tools-top" label="Sponsored Advertisement" minHeight={90} />
